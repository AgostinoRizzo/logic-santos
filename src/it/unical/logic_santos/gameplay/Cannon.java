...
public class Cannon implements IWeapon {
	...
	public static final float FIRE_RATE = 0.8f;
	public static final float ACCURACY  = 0.1f;
	public static final float RANGE     = 0.8f;
	
	public Cannon() {}
	
	public Cannon( AbstractHuman owner, LogicSantosApplication application ) {
		this.owner = owner;
	...
	public IBullet shoot() {
		return new CannonBullet( owner, application );
	}
